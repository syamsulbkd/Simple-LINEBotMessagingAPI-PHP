...
class LINEBotTiny
{
    ...
    public function replyMessage($message, $noencode = false)
    {
        $header = array(
        ...
        if ($noencode) {
            ...
            $response = exec_url('https://api.line.me/v2/bot/message/reply',$this->channelAccessToken,$message);
        } else {
            $context = stream_context_create(array(
                "http" => array(
                    "method" => "POST",
    ...
    {
        return json_decode(exec_url('https://api.line.me/v2/bot/group/'.$groupId.'/leave',$this->channelAccessToken, false));
    }
